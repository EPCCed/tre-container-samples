# EPCC Safe Haven Services Container Samples

Dockerfiles for use with EPCC's [Safe Haven Services](https://docs.eidf.ac.uk/safe-haven-services/overview/) [Container Execution Service (CES)](https://docs.eidf.ac.uk/safe-haven-services/shs-container-user-guide/introduction/).
